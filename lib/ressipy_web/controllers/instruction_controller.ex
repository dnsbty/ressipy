defmodule RessipyWeb.InstructionController do
  ...
  def new(conn, _params) do
    changeset = Recipes.change_instruction(%Recipes.Instruction{})
  ...
  def create(conn, %{"instruction" => instruction_params}) do
    case Recipes.create_instruction(instruction_params) do
      {:ok, instruction} ->
        ...
        |> redirect(to: Routes.instruction_path(conn, :show, instruction))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.instruction_path(conn, :index))
  end
end
