...
window.Recipe = _recipe2.default;
...
;require.register("js/recipe.js", function(exports, require, module) {
'use strict';
...
var Recipe = {
  addIngredient: function addIngredient() {
    ...
    var key = container.getElementsByClassName('row').length;
  ...
  addInstruction: function addInstruction() {
    ...
    var key = container.getElementsByClassName('form-group').length;
